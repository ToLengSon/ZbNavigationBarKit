...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZbNavigationBarKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/835151791@qq.com/ZbNavigationBarKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '835151791@qq.com' => '835151791@qq.com' }
  s.source           = { :git => 'https://github.com/835151791@qq.com/ZbNavigationBarKit.git', :tag => s.version.to_s }
